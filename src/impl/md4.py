''' Original source:
    http://nullege.com/codes/show/src@p@a@passlib-1.6.1@passlib@handlers@windows.py/14/passlib.utils.md4.md4
'''
...
class md4(object):
    ...
    def __init__(self, content=None, state=[0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476], count=0):
        self._count = count / 64
        self._state = state[:]
        self._buf = b('')
        if content:
            self.update(content)
